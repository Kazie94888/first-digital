...
public sealed class SigningInitiatedEvent : OrderAuditEventBase
{
    public SigningInitiatedEvent(SafeSignature signature, OrderId orderId, ClientId clientId, UserInfo auditedBy) :
    ...
    {
        return $"Signature was initiated by {Signer}";
    }
}
