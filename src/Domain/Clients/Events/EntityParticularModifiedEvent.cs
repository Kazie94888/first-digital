...
public sealed class EntityParticularModifiedEvent : ClientAuditEventBase
{
    public EntityParticularModifiedEvent(EntityParticularId entityParticularId, string legalEntityName,
    ...
    {
        return $"Entity '{LegalEntityName}' (#'{RegistrationNumber}') verified";
    }
}