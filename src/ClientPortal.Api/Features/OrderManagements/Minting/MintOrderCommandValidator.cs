...
internal sealed class MintOrderCommandValidator : AbstractValidator<MintOrderCommand>
{
    public MintOrderCommandValidator(ReadOnlyDataContext context, ILogger<MintOrderCommandValidator> logger)
    {
